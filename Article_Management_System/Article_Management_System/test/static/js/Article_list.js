$(function () {
    ...
    var Key = queryParams.keyword;
    var page = queryParams.page;
    var pageNumber = 1; // 当前页码
    var pageSize = 3; // 每页显示的记录数
    var totalRecords = 0; // 总记录数
    document.getElementById('Article_cf').innerText = Key;
    $(function () {
        var jsonDataObj = {
            Page: page,
            keyword: Key,
        ...
        function loadArticles(pageNumber) {
            ...
            $.ajax({
                type: "POST",
                url: "/Search_Article.aspx/Initialize_ArticleList",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                data: jsonDataStr,
                success: function (response) {
                    if (response.d != "false") {
                        ...
                        $('#article-container').html("无结果！").css("color", "red");
                    }
